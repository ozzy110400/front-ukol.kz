  ...
  export const serviceMapping: Record<string, Record<string, ServiceDetails>> = {
    ...
    detox: {
      alcohol: {
        ...
        seoTitle: 'Алкогольная детоксикация на дому в Алматы: вывод из запоя, нарколог',
        seoDescription: 'Профессиональная детоксикация от алкоголя на дому в Алматы. Срочный выезд нарколога, вывод из запоя, капельницы, круглосуточная помощь. Доступные цены, анонимно, гарантия результата – ukol.kz',
        seoH1: 'Алкогольная детоксикация на дому в Алматы. Вывод из запоя',
