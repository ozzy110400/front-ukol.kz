...
export default function Footer() {
  ...
  return (
    <footer className="footer bg-neutral text-my-green p-10 justify-center">
      <div className="flex items-center justify-between gap-12 ">
        <div className="items-center p-2">
            <img src={logoImg} alt="Logo" className="h-8 mb-2  mt-3" />
            <p className="h-8 text-my-green" >
              С вами с 2023 года
            </p>
        </div>
       <div>
          <p className="text-lg text-my-green mb-1 font-semibold">Контакты</p>
          <div className="flex items-center gap-4">
              <a href="https://api.whatsapp.com/send?phone=77027776776">
                <img src={waImg} alt="Logo" className="h-8 mb-2 " />
              </a>
              <a href="https://www.instagram.com/ukol_kz">
                <img src={igImg} alt="Logo" className="h-8 mb-2 " />
              </a>
          </div>
        </div>
      </div>
      <div>
          ...
          <button class="text-md p-2" onClick={() => {
            ...
            <button class="text-md p-2" onClick={() => {
                  const privacyModal = document.getElementById('offer') as HTMLDialogElement;
                  if (privacyModal) {
                    privacyModal.showModal();
                  }
                }}>Договор Оферты</button>
            <p className="mt-2 p-2">Все права защищены &copy;</p>
          </div>
      </div>
